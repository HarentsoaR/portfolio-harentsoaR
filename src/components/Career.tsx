...
export const Career: React.FC = () => {
  ...
  return (
    <section id="career" className="min-h-screen flex flex-col bg-[#222831] text-[#EEEEEE] py-20 md:py-28">
      <motion.div
      ...
      {/* --- TIMELINE CONTAINER --- */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative space-y-16"> {/* Added max-w-6xl here */}
